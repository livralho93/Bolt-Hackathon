...
-- Line items policies
DROP POLICY IF EXISTS "Users can read line items for their trips" ON line_items;
DROP POLICY IF EXISTS "Trip participants can manage line items" ON line_items;
...
DROP POLICY IF EXISTS "Users can read line item participants for their trips" ON line_item_participants;
DROP POLICY IF EXISTS "Trip participants can manage line item participants" ON line_item_participants;
...
DROP POLICY IF EXISTS "Users can read invites for their trips" ON trip_invites;
DROP POLICY IF EXISTS "Trip owners can manage invites" ON trip_invites;
